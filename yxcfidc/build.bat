...
echo /** >> css\yxcfidc.css
echo  * This file was generated by build.bat. >> css\yxcfidc.css
echo  * DO NOT modify it. >> css\yxcfidc.css
echo  * Build Time: %time% %date% >> css\yxcfidc.css
echo  **/ >> css\yxcfidc.css
